...
class Formula(AST):
    ...
    def __init__(self,*args):
        ...
        # print "<bhavya> in Formula type(args)", type(args[0] if len(args)!=0 else None)
...
class Definition(Formula):
    ...
    def __init__(self,*args):
        assert len(args) == 2
        self.args = args
        print "<bhavya> in Definition args", args
    def __repr__(self):
...
class Quantifier(Formula):
    def __init__(self, bounds, body):
        # print "<bhavya> in Quantifier bounds", type(bounds), bounds
        # print "<bhavya> in Quantifier body", type(body), body
        self.bounds = bounds
        self.args = [body]
    def clone(self,args):
...
class Atom(Formula):
    ...
    def __init__(self, relsym, *terms):
        ...
        # print "<bhavya> in Atom args", self.args
        # print "<bhavya> in Atom rep", self.rep
...
class App(Term):
    def __init__(self, funsym, *terms):
        self.rep = funsym
        self.args = flatten(terms)
        # print "<bhavya> in App args", self.args
        # print "<bhavya> in App rep", self.rep
    def __repr__(self):
        if self.args:
...
#        assert isinstance(sort,Sort)
        self.rep = rep
        self.args = []
        self.sort = sort # <bhavya> type str
        # print "<bhavya> in Variable args", self.args
        # print "<bhavya> in Variable rep", self.rep
        # print "<bhavya> in Variable sort", type(sort), self.sort
...
class Decl(AST):
    def __init__(self,*args):
        self.args = args
        self.attributes = ()
        # print "<bhavya> in Decl args", type(args),type(args[0]), args
        # print "<bhavya> in Decl attribute", type(self.attributes), self.attributes
...
class LabeledFormula(AST):
    def __init__(self,*args):
        global lf_counter
        # print "<bhavya> in LabeledFormula init", args
        self.args = args
        self.id = lf_counter
        self.temporal = None
        lf_counter += 1
