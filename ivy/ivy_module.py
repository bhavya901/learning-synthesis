...
class Module(object):
    ...
    def printModule(self):
        print "<bhavya> all_relations ",type(self.all_relations), self.all_relations
        print "<bhavya> definitions ",type(self.definitions), self.definitions
        print "<bhavya> labeled_axioms ",type(self.labeled_axioms), self.labeled_axioms
        print "<bhavya> labeled_props ",type(self.labeled_props), self.labeled_props
        print "<bhavya> labeled_inits ",type(self.labeled_inits), self.labeled_inits
        print "<bhavya> init_cond ",type(self.init_cond), self.init_cond
        print "<bhavya> relations ",type(self.relations), self.relations
        print "<bhavya> functions ",type(self.functions), self.functions
        print "<bhavya> updates ",type(self.updates), self.updates
        print "<bhavya> schemata ",type(self.schemata), self.schemata
        print "<bhavya> theorems ",type(self.theorems), self.theorems
        print "<bhavya> instantiations ",type(self.instantiations), self.instantiations
        print "<bhavya> concept_spaces ",type(self.concept_spaces), self.concept_spaces
        print "<bhavya> labeled_conjs ",type(self.labeled_conjs), self.labeled_conjs
        print "<bhavya> hierarchy ",type(self.hierarchy), self.hierarchy
        print "<bhavya> actions ",type(self.actions), self.actions
        print "<bhavya> predicates ",type(self.predicates), self.predicates
        print "<bhavya> assertions ",type(self.assertions), self.assertions
        print "<bhavya> mixins ",type(self.mixins), self.mixins
        print "<bhavya> public_actions ",type(self.public_actions), self.public_actions
        print "<bhavya> isolates ",type(self.isolates), self.isolates
        print "<bhavya> exports ",type(self.exports), self.exports
        print "<bhavya> imports ",type(self.imports), self.imports
        print "<bhavya> delegates ",type(self.delegates), self.delegates
        print "<bhavya> public_actions ",type(self.public_actions), self.public_actions
        print "<bhavya> progress ",type(self.progress), self.progress
        print "<bhavya> rely ",type(self.rely), self.rely
        print "<bhavya> mixord ",type(self.mixord), self.mixord
        print "<bhavya> destructor_sorts ",type(self.destructor_sorts), self.destructor_sorts
        print "<bhavya> sort_destructors ",type(self.sort_destructors), self.sort_destructors
        print "<bhavya> privates ",type(self.privates), self.privates
        print "<bhavya> interps ",type(self.interps), self.interps
        print "<bhavya> natives ",type(self.natives), self.natives
        print "<bhavya> native_definitions ",type(self.native_definitions), self.native_definitions
        print "<bhavya> initializers ",type(self.initializers), self.initializers
        print "<bhavya> params ",type(self.params), self.params
        print "<bhavya> ghost_sorts ",type(self.ghost_sorts), self.ghost_sorts
        print "<bhavya> native_types ",type(self.native_types), self.native_types
        print "<bhavya> sort_order ",type(self.sort_order), self.sort_order
        print "<bhavya> symbol_order ",type(self.symbol_order), self.symbol_order
        print "<bhavya> aliases ",type(self.aliases), self.aliases
        print "<bhavya> before_export ",type(self.before_export), self.before_export
        print "<bhavya> attributes ",type(self.attributes), self.attributes
        print "<bhavya> variants ",type(self.variants), self.variants
        print "<bhavya> ext_preconds ",type(self.ext_preconds), self.ext_preconds
        print "<bhavya> proofs ",type(self.proofs), self.proofs
        print "<bhavya> named ",type(self.named), self.named
        print "<bhavya> subgoals ",type(self.subgoals), self.subgoals
        print "<bhavya> isolate_info ",type(self.isolate_info), self.isolate_info
        print "<bhavya> conj_actions ",type(self.conj_actions), self.conj_actions
        print "<bhavya> sig:", type(self.sig), self.sig
